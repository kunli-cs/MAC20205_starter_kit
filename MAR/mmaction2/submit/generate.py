...
pickle_file_path = 'submit/test_result.pickle'
pred_file_path = 'submit/prediction.csv'
predzip_file_path = 'submit/submission.zip'
...
with open(pred_file_path, 'w', newline='') as f:
    ...
    for index, data in enumerate(datas):
        ...
        pred_scores = data['pred_score'].cpu()
        top5_fine = torch.topk(pred_scores, k=5).indices.tolist()
